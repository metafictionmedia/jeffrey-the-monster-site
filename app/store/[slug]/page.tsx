...
export default function ProductPage() {
    ...
    return (
      <div className="container mx-auto px-4 py-12 sm:py-20">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4 text-light-text dark:text-white">Product Not Found</h1>
  ...
  return (
    <div className="min-h-screen bg-background bg-grid-light dark:bg-grid-dark bg-grid p-4">
      <div className="container mx-auto px-4 py-12 sm:py-20">
        <Link
          href="/store"

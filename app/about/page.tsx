...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-12 sm:py-20 space-y-16">
      ...
      {/* --- Concept Art Section --- */}
      <section>
        <h2 className="text-5xl text-center mb-8">Concept Art</h2>
      ...
      <section>
        <h2 className="text-5xl text-center mb-8">About the Creator</h2>
        <div className="comic-panel p-8 grid md:grid-cols-3 gap-8 items-start">
          ...
          <div className="md:col-span-2">
            <h3 className="text-4xl mb-2">Phil Marquez</h3>
            <h4 className="text-xl font-sans font-semibold text-light-text-secondary dark:text-dark-text-secondary mb-4">Owner & Founder, Metafiction Media</h4>

          ...
          {comics.length === 0 ? (
            ...
            <>
              <div className="flex-1 flex flex-col items-center justify-center min-h-0">
                <Link href={`/comics/${currentComic.id}`} className="h-full w-full flex items-center justify-center">
                  <div
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                      ...
                      <p className="text-white/90 text-xs mt-2 font-semibold">Click to read →</p>
                    </div>
                  </div>
                </Link>
              </div>
